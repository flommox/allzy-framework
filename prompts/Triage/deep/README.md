...
This folder contains the deep Triage prompt type for unclear, risky, multi-scope, or research-heavy maintenance.
...
- Use [`../standard/000_universal.md`](../standard/000_universal.md) for normal maintenance.
- Use [`../fast/000_universal.md`](../fast/000_universal.md) for one obvious low-risk issue.
