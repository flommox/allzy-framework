---
id: "allzy.framework.prompts.triage.deep.universal"
title: "Triage Deep Prompt — Universal"
...
Use this prompt when you need to turn messy maintenance context into a clean execution handoff.
...
Do not use it when the user wants Agent 1 to directly edit code.

Do not use it to generate patches.

Do not use it to rewrite architecture.

Do not use it to implement a new feature from scratch.

Do not use it to replace Genesis, Segmentation, Modularization, or Yin/Yang Specification.
