# Workspace Maintenance Prompt

This folder contains the workspace-maintenance prompt type for existing workspace context layers.
...
- Use [`../full/000_universal.md`](../full/000_universal.md) for first-time setup or complete workspace-context generation.
- Use [`../artifact-prompts/README.md`](../artifact-prompts/README.md) when the task should touch only one support artifact.
