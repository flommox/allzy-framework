...
This folder contains the full workspace-context initialization prompt type.
...
- Use [`../maintenance/000_universal.md`](../maintenance/000_universal.md) when the workspace already exists and needs upkeep rather than initialization.
- Use [`../artifact-prompts/README.md`](../artifact-prompts/README.md) when only one support artifact needs to be created or repaired.
