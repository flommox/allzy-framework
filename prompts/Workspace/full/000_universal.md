---
id: "allzy.framework.prompts.workspace.workspace-context-initialization.universal"
title: "Workspace Context Initialization Prompt — Universal"
...
Use this prompt to initialize, inspect, or repair the **workspace context layer** for an Allzy Framework project.

This prompt prepares the target implementation workspace so future AI agents can work from defined context instead of guessing.

It sets up or checks the project/session context artifacts used by AI agents, including:
...
1. **Website / Preconfigured Mode**  
   The user selects options in a UI. The generated prompt includes filled config values. The assistant should not ask those questions again.
