...
This folder contains the prompt type for creating, updating, or inspecting `memory.md`.
...
- Use [`../plan-md/000_universal.md`](../plan-md/000_universal.md) for current task focus rather than lasting project truth.
- Use [`../context-package-generation/000_universal.md`](../context-package-generation/000_universal.md) for one task-specific selected context package rather than repository memory.
