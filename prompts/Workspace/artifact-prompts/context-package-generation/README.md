# Context Package Generation Prompt

This folder contains the prompt type for generating one task-specific context package.
...
- Use [`../context-retrieval/000_universal.md`](../context-retrieval/000_universal.md) for the reusable `context_retrieval.md` method file.
- Use [`../../../Retrieval/context-retrieval-builder/000_universal.md`](../../../Retrieval/context-retrieval-builder/000_universal.md) when the task is broader retrieval planning rather than one workspace package artifact.
