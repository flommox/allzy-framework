...
This folder contains the review prompt type for Yin/Yang artifact alignment and safety checks.
...
- Use this review when the concern is alignment between Yin intent and Yang contract rules.
- Use [`../framework-docs-consistency-review/000_universal.md`](../framework-docs-consistency-review/000_universal.md) for framework-documentation review.
- Use [`../template-prompt-consistency-review/000_universal.md`](../template-prompt-consistency-review/000_universal.md) for prompt/template/README review.
