...
This folder contains the review prompt type for framework documentation consistency.
...
- Use [`../template-prompt-consistency-review/000_universal.md`](../template-prompt-consistency-review/000_universal.md) when the target is prompts, templates, or README organization.
- Use [`../yin-yang-consistency-review/000_universal.md`](../yin-yang-consistency-review/000_universal.md) when the target is Yin/Yang artifact alignment.
