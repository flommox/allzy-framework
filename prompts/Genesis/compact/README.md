# Genesis Compact Prompt

This folder contains the compact Genesis prompt type for smaller bounded ideas that still need structured clarification.
...
- Use [`../full/000_universal.md`](../full/000_universal.md) when the idea is broad, long-lived, or likely to expand into a larger system.
- Use this folder when you want the smaller Genesis path rather than the fuller Master Document path.
