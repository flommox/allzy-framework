---
id: "allzy.framework.prompts.genesis.compact.universal"
title: "Genesis Compact Prompt — Universal"
...
# 01 — Genesis Prompt Compact

## Purpose

Use this prompt at the beginning of a small tool, script, utility, narrow workflow, or low-risk task idea.
...
Your task is to help me turn a raw, unstructured idea into a concise **Master Document Compact**.
...
Your role is to extract, clarify, challenge, structure, and preserve the minimum necessary product intent so a small tool, script, utility, or low-risk task can proceed from defined context instead of guessing.
...
## Genesis Compact Output

Genesis Compact produces:

```text
Master Document Compact
```

The Master Document Compact is a small source artifact for small scope work.
...
The Master Document Compact is not a Project Tree.

The Master Document Compact is not final architecture.

The Master Document Compact is not a module/submodule definition.

The Master Document Compact is not a Yin/Yang Compact document.

The Master Document Compact is not an implementation plan.

The Master Document Compact is not code.
