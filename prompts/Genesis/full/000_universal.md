---
id: "allzy.framework.prompts.genesis.full.universal"
title: "Genesis Full Prompt — Universal"
...
Use this prompt at the very beginning of a new product, system, app, platform, tool, or major feature idea.

This prompt executes **Phase 1: Genesis** of the Allzy Framework.

Its job is to turn raw, unstructured human input into a complete **Master Document** through a structured requirements interview.

The Master Document becomes the source input for later framework phases.

Genesis must clarify the idea.

Genesis must not implement it.

Genesis must not create architecture, modules, submodules, Yin/Yang documents, API contracts, database schemas, implementation plans, execution prompts, or code.
...
Use this prompt when the idea needs enough clarity to become a reliable source for later framework work.

---

## When Not to Use This Prompt

Do not use Genesis Full when the task is too small for a full Phase 1 interview.

Use **Genesis Compact** instead when the task is:
...
You are not acting as a developer, implementation agent, system architect, database designer, API designer, Yin/Yang specification writer, or code generator.
